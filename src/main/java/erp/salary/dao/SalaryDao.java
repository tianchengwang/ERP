...
public interface SalaryDao extends BaseDao<Salary> {
	 ...
	 * @param 注解进行声明
	 * */
	List<Salary> findObjects(@Param("startIndex")Integer startIndex,@Param("pageSize")Integer pageSize);
	
	/**根据id执行查询操作
	 * @param id 来自页面上的某条记录的id
	 * */
	Salary findObjectById(@Param("id")Integer id);
	
	Salary findObjectByEId(@Param("id")Integer id);
	 ...
	 * *//*
	int statusById(
			@Param("SalaryId")String SalaryId,
