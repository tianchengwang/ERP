...
public interface EmployeeDao extends BaseDao<Employee> {
	 ...
	 * @param 注解进行声明
	 * */
	List<Employee> findObjects(@Param("name")String name,@Param("valid")Integer valid,@Param("startIndex")Integer startIndex,@Param("pageSize")Integer pageSize);
	...
	Employee findObjectByEmployeeId(@Param("employeeid")String employeeid);
	/**获得总记录数
	 * @param name 模糊查询时输入的项目
	 * @param valid 项目启用、禁用状态(1,0)
	 * @return 总记录数
