...
<script type="text/javascript" src="${basePath}/employee/employee/employee_list.js"></script>
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="seachform">
	    	...
	    	<li><input id="btn-search" name="" type="button" class="scbtn btn-search" value="查询"/></li>
	    	<li><label>&nbsp;</label><input id="btn-add" name="" type="button" class="scbtn btn-add" value="新增"/></li>
	    	<li><label>&nbsp;</label><input id="btn-valid" name="" type="button" class="scbtn btn-valid" value="在职"/></li>
	    	<li><label>&nbsp;</label><input id="btn-invalid" name="" type="button" class="scbtn btn-invalid" value="离职"/></li>
        </ul>
