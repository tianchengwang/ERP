...
function doFindObjectById(id){
	var url="doFindMessageObjectById.do"
	var params={"id":id};
...
function doInitEditFormData(obj){
	$("#question").val(obj.m_question);
	$("#answer").val(obj.m_answer);
...
function doSaveOrUpdate(){
	...
	//根据id是否有值来判定是修改还是添加
	var updateUrl="doUpdateMessageObject.do";
	var insertUrl="insertMessage.do";
