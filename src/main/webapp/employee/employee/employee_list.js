$(document).ready(function(){
	...
	//在禁用和启用按钮上注册点击事件
	$(".seachform").on("click",".btn-valid,.btn-invalid",doValidById);		
	//在添加,修改按钮上注册点击事件
	$('.rightinfo')
...
function setTableBodyRows(result){//result 为一个json对象
	...
	tr.append("<td>"+result[i].employeeName+"</td>");
	tr.append("<td>"+result[i].sex+"</td>");
	tr.append("<td>"+result[i].birthday+"</td>");
	tr.append("<td>"+result[i].nativePlace+"</td>");
	tr.append("<td>"+result[i].grade+"</td>");
	tr.append("<td>"+result[i].company+"</td>");
